...
const EditDocument: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("islam")
      const response = await axiosPrivate.patch(`${DOCUMENT_URL}/${id}`, formData,
      {
        headers: {'Content-Type': 'multipart/form-data'},
        withCredentials: true
      });
      let documentTitle = response.data.title;
      setSuccessMsg(`document -> ${documentTitle} updated successfully`)
  ...
  useEffect(() => {
    ...
    const getDocuemnt = async () => {
        try {
            const response = await axiosPrivate.get(`${DOCUMENT_URL}/${id}`, {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Add A Document" />
