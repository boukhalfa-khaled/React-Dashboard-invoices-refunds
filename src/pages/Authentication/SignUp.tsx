...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEmail('');
      setPassword('');
      setSuccessMsg("You successfully register your account please check you email to veriy your account")
      setErrMsg('')
    } catch (err) {
      if(!err?.response){
          ...
          {!successMsg ? '' :  <div className="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-4 mb-3">
            ...
            <div className="w-full">
              <h5 className="mb-3 text-lg font-semibold text-black dark:text-[#34D399] ">
                {successMsg}
                You successfully register your account please check your email to veriy your account
              </h5>
            </div>
          </div>}
